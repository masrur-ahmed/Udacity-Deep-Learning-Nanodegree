...
* [Introduction to Neural Networks](https://github.com/masrur-ahmed/deep-learning-v2-pytorch/tree/master/intro-neural-networks): Learn how to implement gradient descent and apply it to predicting patterns in student admissions data.
